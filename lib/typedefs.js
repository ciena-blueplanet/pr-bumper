 ...
 *
 * @typedef BitbucketCloudPullRequest
 * @property {Number} id - the PR #
 * @property {String} description - the description of the PR
 * @property {BitbucketCloudEndpoint} source - the ref of the source of the pr
 * @property {BitbucketCloudEndpoint} destination - the ref of the source of the pr
 * @property {BitbucketCloudCommit} source.commit - the ref of the source commit of the pr
 * @property {BitbucketCloudCommit} destination.commit - the ref of the destination commit of the pr
 * @property {BitbucketCloudLinks} links - http links
