 ...
 * @property {BitbucketCommit} source.commit - the ref of the source commit of the pr
 * @property {BitbucketCommit} destination.commit - the ref of the destination commit of the pr
